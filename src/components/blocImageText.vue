           ...
           <div class="row g-0">
             ...
             <div class="col-lg-6">
               <div class="content d-flex flex-column justify-content-center h-100">
                 ...
                 <ul>
                  <!--li><i class="bi bi-check-circle"></i> Les religions sont mal connues et mal comprises. Le christianisme est mal connu, l'islam est mal enseigné, le vodun est mal compris, les religions endogènes sont méconnues. </li-->
